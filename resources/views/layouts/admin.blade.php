  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0 text-center" href="{{url('dashboard')}}" target="_blank">
        <h4 class="font-weight-bold text-white text-center">E-STORE</h4>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item {{Request::is('categories') ? 'bg-gradient-primary': ''}}">
          ...
          <li class="nav-item {{Request::is('category/add') ? 'bg-gradient-primary': ''}}">
              <a class="nav-link text-white " href="{{route('add.category')}}">
                  <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                      <i class="material-icons opacity-10">table_view</i>
                  </div>
          ...
          <li class="nav-item {{Request::is('products/add') ? 'bg-gradient-primary': ''}}">
              <a class="nav-link text-white " href="{{route('add.products')}}">
                  <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                      <i class="material-icons opacity-10">table_view</i>
                  </div>
        ...
        <li class="nav-item {{Request::is('orders') ? 'bg-gradient-primary': ''}}">
          ...
          <li class="nav-item {{Request::is('users') ? 'bg-gradient-primary': ''}}">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item dropdown pe-2 d-flex align-items-center">
              <a href="{{url('/')}}" class="nav-link text-body p-0" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
            <a href="{{url('/')}}">
                Go to site
            </a>
